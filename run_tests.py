...
def main():
    ...
    parser.add_argument('--fast', action='store_true', help='Run only fast tests (skip integration)')
    parser.add_argument('--integration', action='store_true', help='Run only integration tests')
    parser.add_argument('--models', action='store_true', help='Run only model tests')
    parser.add_argument('--visualizations', action='store_true', help='Run only visualization tests')
    parser.add_argument('--interactive', action='store_true', help='Run only interactive visualization tests')
    ...
    # Add coverage
    if args.coverage:
        cmd.extend(['--cov=models', '--cov=generate_embeddings', '--cov=generate_visualizations', '--cov=interactive_visualizations'])
    ...
    if args.tests:
        ...
        # Model tests only
        cmd.extend(['tests/test_base_model.py', 'tests/test_models.py', 'tests/test_embedding_generation.py'])
